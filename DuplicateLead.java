...
public static void main(String[] args) {
	...
	WebElement duplicateleadElement = driver.findElement(By.xpath("//a[text()='Duplicate Lead']"));
	duplicateleadElement.click();
	WebElement companyname2Element = driver.findElement(By.id("createLeadForm_companyName"));
	companyname2Element.clear();
	WebElement firstname2Element = driver.findElement(By.id("createLeadForm_firstName"));
	firstname2Element.clear();
	companyname2Element.sendKeys("TCS");
	firstname2Element.sendKeys("Mahi");
	WebElement submitbutton2Element = driver.findElement(By.name("submitButton"));
